...
export default function CreateFormPage() {
  ...
  const [fields, setFields] = useState<any[]>([
    ...
    { id: "email", label: "Email", type: "email", required: true, order: 3 },
    { id: "phone", label: "Phone", type: "phone", required: false, order: 4 },
    { id: "resume", label: "Resume", type: "file", required: true, order: 5 },
  ])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/integrations/forms`, {
        method: "POST",
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <div>
        <h2 className="text-2xl font-bold tracking-tight">Create New Form</h2>
        <p className="text-muted-foreground">Design your application form.</p>
      </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid gap-2">
              ...
              <textarea
                ...
                placeholder="Brief description of the role or application process"
              />
            </div>
          </CardContent>
        </Card>
