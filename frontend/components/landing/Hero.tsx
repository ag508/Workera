...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-white to-[var(--gray-50)] pt-20 pb-32">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <h1 className="text-5xl lg:text-6xl font-bold leading-tight mb-6 text-[var(--gray-900)]">
              Intelligent Resume Parsing and{" "}
              <span className="text-[var(--emerald)]">Recruitment Automation</span>
            </h1>
            <p className="text-xl text-[var(--gray-600)] mb-8 max-w-2xl mx-auto lg:mx-0">
          ...
          <div className="flex-1">
            <div className="relative">
              <div className="glass rounded-2xl p-8 shadow-2xl">
                <div className="bg-gradient-to-br from-[var(--emerald)] to-[var(--mint)] rounded-xl p-8 text-white">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center">
                      <svg className="w-6 h-6 text-[var(--emerald)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                    </div>
                    <div>
                      <h3 className="font-semibold text-lg">AI-Powered Matching</h3>
                      <p className="text-sm text-white/80">Real-time candidate scoring</p>
                    </div>
                  </div>
                  <div className="space-y-3">
                    ...
                    <div className="bg-white/20 backdrop-blur rounded-lg p-4">
                      <div className="flex justify-between items-center mb-2">
                        <span className="text-sm font-medium">Experience Fit</span>
